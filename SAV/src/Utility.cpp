...
unsigned int ToHex(glm::vec3 rgbColor) {
    ...
    hexColor |= static_cast<unsigned int>(rgbColor.r * 255.0);
    hexColor <<= 8;
    hexColor |= static_cast<unsigned int>(rgbColor.g * 255.0);
    hexColor <<= 8;
    hexColor |= static_cast<unsigned int>(rgbColor.b * 255.0);
